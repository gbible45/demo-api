...
public abstract class LemonSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public static final String GOOD_DEVELOPER = "GOOD_DEVELOPER";
	public static final String GOOD_AUDITOR = "GOOD_AUDITOR";
	public static final String GOOD_MONITOR = "GOOD_MONITOR";
	...
	protected void logout(HttpSecurity http) throws Exception {
		...
		.logout()
			...
			.deleteCookies(LemonCsrfFilter.SESSION_ID_NAME);
	}
	...
	protected void authorizeRequests(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			//.antMatchers("/api/portal/admin/**").hasRole(GOOD_ADMIN)
			//.antMatchers("/api/portal/**").authenticated()
			//.antMatchers("/api/comm/**").anonymous()
